        ...
        <div className="flex items-center lg:gap-8 gap-0">
          <Link className="lg:block hidden" href="/">
            <div className="flex w-fit space-x-2 items-center">
              <ShoppingBasket />
              <h2 className="scroll-m-20 text-xl font-semibold tracking-tight">Urban Dukaan</h2>
            </div>
          </Link>
                    ...
                    <li className="row-span-3">
                      <NavigationMenuLink asChild>
                        ...
                        >
                            ...
                            <div className="mb-2 mt-4 text-lg font-medium">Urban Dukaan</div>
                            <p className="text-sm leading-tight text-muted-foreground">
                            Discover. Shop. Repeat. Your Ultimate Shopping Destination. 
                            </p>
                        </Link>
                      </NavigationMenuLink>
                    </li>
