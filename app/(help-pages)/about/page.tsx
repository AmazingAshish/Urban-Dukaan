        ...
        <article className="grid items-center gap-8 container max-w-3xl py-8 md:py-10 lg:py-10">
            ...
            <section className="mdx">
                ...
                >
                    ...
                    a passionate Web Developer with a specialization in
                ...
                <ul className="my-6 ml-6 list-disc">
                    ...
                    <li className="mt-2">
                        <Link 
                            className="font-medium underline underline-offset-4"
                            href="https://github.com/AmazingAshish"
                            target="_blank"
                        >
                            GitHub
                        </Link>
                    ...
                    <li className="mt-2">
                        <Link 
                            className="font-medium underline underline-offset-4"
                            href="https://www.linkedin.com/in/amazingashish/"
                            target="_blank"
                        >
                            Linkedin
                        </Link>
                ...
                <ul className="my-6 ml-6 list-disc">
                    <li className="mt-2">
                        <Link 
                            className="font-medium underline underline-offset-4"
                            href="https://portfolio-ashish-orcin.vercel.app/"
                            target="_blank"
                        >
                            portfolio-ashish-orcin.vercel.app
                        </Link>
                    </li>
                </ul>
            </section>
